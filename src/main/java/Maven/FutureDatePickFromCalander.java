...
/**
 * Created by Mehul on 23/04/2017.
 */
public class FutureDatePickFromCalander
{

    @Test

    public void FutureDatePick () throws InterruptedException, AWTException {
        ...
        java.util.List<WebElement> dates = driver.findElements(By.xpath("//div[@id='rb-calendar_onward_cal']/table//td"));
